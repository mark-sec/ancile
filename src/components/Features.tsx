  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
            We're excited to introduce our innovative trading loss insurance product.
            Every trader knows having a bad day is part of the trading journey.
            Our mission is to make those bad days better.
        </Typography>
      </Box>
      <Box
        sx={{
