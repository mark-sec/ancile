    ...
    >
      ...
      >
        ...
        >
          ...
          <StyledBox id="image" sx={{ width: '100%', height: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src={ancile_home} style={{ width: '100%', height: 'auto' }} alt="Ancile Home" />
          </StyledBox>
      </Container>
    </Box>
  );
